...
public class ModPow2_FuzzDriver {
    ...
    public static void main(String[] args) {
        ...
        Mem.clear(true);
        BigInteger result1 = ModPow2.modPow2_safe(public_base, secret1_exponent, public_modulus, bitLength1);
        System.out.println("result1: " + result1);
        long cost1 = Mem.instrCost;
        System.out.println("cost1=" + cost1);
        Mem.clear(false);

        BigInteger result2 = ModPow2.modPow2_safe(public_base, secret2_exponent, public_modulus, bitLength2);
