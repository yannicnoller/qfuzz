...
public class PasswordEncoderUtils_FuzzDriver {
    public static void main(String[] args) {
       ...
       // Read all inputs.
        ...
        Mem.clear(true);
        boolean result1 = PasswordEncoderUtils.equals_safe(secret1_expected, public_actual);
        System.out.println("Answer1: " + result1);
        long cost1 = Mem.instrCost;
        System.out.println("cost1=" + cost1);
        Mem.clear(false);

        boolean result2 = PasswordEncoderUtils.equals_safe(secret2_expected, public_actual);
