...
public class Driver {
    ...
    public static void main(String[] args) {
        ...
        try (FileInputStream fis = new FileInputStream(args[0])) {
            ...
            storedPassword_secret1 = new String(tmp_array);

            tmp_array = new char[eachSize];
            for (i = 0; i < eachSize; i++) {
                tmp_array[i] = values.get(i + 2 * eachSize);
            }
            storedPassword_secret2 = new String(tmp_array);
        ...
        try {
        	SimplifiedUsernameTokenValidatorImpl.verifyPlaintextPassword(passwordType, storedPassword_secret1);
			valid1 = true;
        ...
        try {
        	SimplifiedUsernameTokenValidatorImpl.verifyPlaintextPassword(passwordType, storedPassword_secret2);
			valid2 = true;
