...
public class K96_FuzzDriver {
    ...
    public static void main(String[] args) {
        ...
        Mem.clear(true);
        BigInteger result1 = K96.modular_exponentiation_safe(public_y, secret1_x, public_n, bitLength1);
        System.out.println("Answer1: " + result1);
        long cost1 = Mem.instrCost;
        System.out.println("cost1=" + cost1);
        Mem.clear(false);
      
        BigInteger result2 = K96.modular_exponentiation_safe(public_y, secret2_x, public_n, bitLength2);
